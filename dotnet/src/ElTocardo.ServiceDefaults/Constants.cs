...
{
    public const string PostgresServerResourceName = "postgres";
    public const string PostgresDatabaseResourceName = "el-tocardo-db-postgres";
    public const string ElTocardoMigrationsProjectResourceName = "migrations";
    public const string MongoDbServerResourceName = "mongodb";
